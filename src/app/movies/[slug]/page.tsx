    ...
    >
      <div className="flex items-center justify-between gap-2">
        <Link
          ...
          className="wr-btn-ghost wr-btn-icon inline-flex h-11 w-11 items-center justify-center"
        >
            ...
            <div className="flex items-center gap-1.5">
              ...
              <form action={deleteMovie}>
                ...
                <ConfirmSubmitButton
                  ...
                  title="Delete movie"
                  className="wr-btn-ghost wr-btn-icon inline-flex h-11 w-11 items-center justify-center text-red-700 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-950/35"
                >
